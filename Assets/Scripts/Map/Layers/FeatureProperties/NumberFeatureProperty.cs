/// <summary>
/// Describes a feature's Number property
/// </summary>
public struct NumberFeatureProperty : IFeatureProperty
{
    ...
    /// <summary>
    /// Constructs a new NumberFeatureProperty
    /// </summary>
    ...
    public NumberFeatureProperty(string key, string displayName, string formatString)
    {
        this.Key = key;
    ...
    public bool MatchesFilter(Feature feature)
    {
        ...
        {
            double? value = feature.GetPropertyAsNullableDouble(Key);
            switch (Filter)
            {
