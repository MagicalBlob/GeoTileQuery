...
public class Map
{
    ...
    public Map()
    {
        ...
        Layers.Add("StamenToner", new RasterLayer(this, "StamenToner", "Toner", "High-contrast B&W maps for data mashups and exploring river meanders and coastal zones", "Stamen Design", DateTime.MinValue, false, 15, 19, defaultRasterRenderer, "https://stamen-tiles-c.a.ssl.fastly.net/toner/{0}.png"));
        Layers.Add("StamenTerrain", new RasterLayer(this, "StamenTerrain", "Terrain", "Terrain maps featuring hill shading and natural vegetation color", "Stamen Design", DateTime.MinValue, false, 15, 19, defaultRasterRenderer, "https://stamen-tiles-c.a.ssl.fastly.net/terrain/{0}.png"));
