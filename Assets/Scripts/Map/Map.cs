...
public class Map
{
    ...
    public Map()
    {
        ...
        Layers.Add("StamenWatercolor", new RasterLayer(this, "StamenWatercolor", "Watercolor", "A watercolor styled design, reminiscent of hand drawn maps", "Stamen Design", DateTime.MinValue, true, 15, 19, defaultRasterRenderer, "https://tiles.stadiamaps.com/tiles/stamen_watercolor/{0}.jpg"));
