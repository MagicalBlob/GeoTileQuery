...
public class Map
{
    ...
    public Map()
    {
        ...
        Layers.Add("StamenWatercolor", new RasterLayer("StamenWatercolor", "Stamen - Watercolor", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, true, defaultRasterRenderer, "https://stamen-tiles-b.a.ssl.fastly.net/watercolor/{0}.jpg"));
        Layers.Add("StamenToner", new RasterLayer("StamenToner", "Stamen - Toner", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, false, defaultRasterRenderer, "https://stamen-tiles-c.a.ssl.fastly.net/toner/{0}.png"));
        Layers.Add("StamenTerrain", new RasterLayer("StamenTerrain", "Stamen - Terrain", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, false, defaultRasterRenderer, "https://stamen-tiles-c.a.ssl.fastly.net/terrain/{0}.png"));
        Layers.Add("OSMStandard", new RasterLayer("OSMStandard", "OpenStreetMap", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, false, defaultRasterRenderer, "https://tile.openstreetmap.org/{0}.png"));
        Layers.Add("MapboxSatellite", new RasterLayer("MapboxSatellite", "Mapbox Satellite", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, false, defaultRasterRenderer, $"https://api.mapbox.com/v4/mapbox.satellite/{{0}}.jpg?access_token={MainController.MapboxAccessToken}"));
        ...
        Layers.Add("Electrical_PS", new GeoJsonLayer("Electrical_PS", "Electrical PS", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.MinValue, true, defaultGeoJsonRenderer, geoJsonBaseUrl + "/Electrical_PS/{0}.geojson", null, new IFeatureProperty[] { new StringFeatureProperty("PS", "Posto de Seccionamento", "{0}") }));
