...
public class Map
{
    ...
    public Map()
    {
        ...
        string geoJsonBaseUrl = useLocalhost ? "http://localhost:8123" : "https://tese.flamino.eu/api/tiles/";
        ...
        Layers.Add("Electrical_IP_especial", new GeoJsonLayer("Electrical_IP_especial", "Electrical Iluminação Pública Especial", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.UnixEpoch, true, defaultGeoJsonRenderer, geoJsonBaseUrl + "/Electrical_IP_especial/{0}.geojson", null, new IFeatureProperty[] { new StringFeatureProperty("IP_ESPECIA", "Iluminação Pública Especial", "{1}: {0}") }));
        Layers.Add("Electrical_PS", new GeoJsonLayer("Electrical_PS", "Electrical PS", "DESCRIPTION", "<a href=\"https://example.com\">DATA_SOURCE</a>", System.DateTime.UnixEpoch, true, defaultGeoJsonRenderer, geoJsonBaseUrl + "/Electrical_PS/{0}.geojson", null, new IFeatureProperty[] { new StringFeatureProperty("PS", "Posto de Seccionamento", "{1}: {0}") }));
